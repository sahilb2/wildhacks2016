...
var img_src = [];
//console.log("running");
var nsfw_img = 'https://i.imgur.com/TKKFPFr.png';
//console.log("running");
for (var i = 0, l = images.length; i < l; i++){
  //console.log("running");
  //console.log(images[i].src);
  img_src[i] = images[i].src;
}
// // for (var i = 0, l = images.length; i < l; i++) {
// "https://samples.clarifai.com/metro-north.jpg"
  app.models.predict(Clarifai.NSFW_MODEL,'https://assets.barcroftmedia.com.s3-website-eu-west-1.amazonaws.com/assets/images/recent-images-11.jpg').then(
    function(response){
      // if(resonse[0]['name']=='safe'){
...
module.exports = function xhrAdapter(resolve, reject, config) {
  ...
  // DON'T do this for testing b/c XMLhttpsRequest is mocked, not XDomainRequest.
...
},{"../helpers/settle":16,"./../helpers/btoa":9,"./../helpers/buildURL":10,"./../helpers/cookies":12,"./../helpers/isURLSameOrigin":14,"./../helpers/parseHeaders":15,"./../helpers/transformData":18,"./../utils":19,"_process":33}],4:[function(require,module,exports){
'use strict';
...
module.exports = function dispatchRequest(config) {
  return new Promise(function executor(resolve, reject) {
    try {
      ...
      } else if (typeof XMLhttpsRequest !== 'undefined') {
        // For browsers use XHR adapter
        adapter = require('../adapters/xhr');
      } else if (typeof process !== 'undefined') {
        // For node use https adapter
        // adapter = require('../adapters/https');
      }
...
},{"../adapters/https":3,"../adapters/xhr":3,"_process":33}],7:[function(require,module,exports){
'use strict';
...
},{"./Concepts":22,"./Inputs":24,"./Models":26,"./constants":27,"_process":33,"axios":2,"es6-promise":32}],21:[function(require,module,exports){
"use strict";
...
},{"./Concepts":22,"./Model":25,"./constants":27,"./helpers":28,"./utils":30,"axios":2,"es6-promise":32}],27:[function(require,module,exports){
'use strict';
...
},{"./App":20}],30:[function(require,module,exports){
'use strict';
...
},{"./../package.json":31,"./constants":27,"./helpers":28,"es6-promise":32}],31:[function(require,module,exports){
module.exports={
  "_args": [
    [
      {
  ...
  "_npmOperationalInternal": {
    ...
    "tmp": "tmp/clarifai-2.0.16.tgz_1479159813036_0.8937706700526178"
  },
  "_npmUser": {
    "name": "clarifai-jade",
  ...
  "_resolved": "https://registry.npmjs.org/clarifai/-/clarifai-2.0.16.tgz",
  "_shasum": "de864364be5af8135be361776ae3ad91052635ee",
  "_shrinkwrap": null,
  "_spec": "clarifai",
  "_where": "/Users/sahilbhatt",
  "author": {
    "name": "Clarifai Inc."
  },
  "bugs": {
  ...
  "directories": {},
  "dist": {
    "shasum": "de864364be5af8135be361776ae3ad91052635ee",
    "tarball": "https://registry.npmjs.org/clarifai/-/clarifai-2.0.16.tgz"
  },
  "gitHead": "b6321c9f8ffc66204ef5397bd07218a8977d9e4e",
